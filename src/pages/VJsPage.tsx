...
export function VJsPage() {
  ...
  const availableDays = useMemo(() => {
    ...
    festivalData.vjs.forEach(stage => {
  ...
  return (
    <div className="page">
      <h1 className="page-title">VJs</h1>
          ...
          <div key={day} className="day-group">
            ...
            {events.map((event, idx) => (
              <EventCard
                ...
                id={generateEventId('vjs', event.day, event.name, event.startTime, event.location)}
                name={event.name}
